...
if strcmp(apriori_rois,'unilateral_MD')==1
    roi_dir = '/media/tw260/X6/Effort/ROIs/MD rois/unilateral';
...
elseif strcmp(apriori_rois,'bilateral_DMN')==1
    roi_dir = '/media/tw260/X6/Effort/ROIs/DMN rois/bilateral';
...
elseif strcmp(apriori_rois,'DMN_network')==1
    roi_dir = '/media/tw260/X6/Effort/ROIs/DMN rois';
    roinames = {'DMNnetwork.nii'};
elseif strcmp(apriori_rois,'unilateral_reward')==1
    roi_dir = '/media/tw260/X6/Effort/ROIs/reward rois/unilateral';
...
elseif strcmp(apriori_rois,'bilateral_reward')==1
    roi_dir = '/media/tw260/X6/Effort/ROIs/reward rois/bilateral';
    roinames = {'ACC.nii','AI.nii','striatum.nii','thalamus.nii'};
elseif strcmp(apriori_rois,'reward_network')==1
    roi_dir = '/media/tw260/X6/Effort/ROIs/reward rois';
...
% outputfolder
outputfolder = '/media/tw260/X6/Effort/analysis/results/ROI_betavalues';
...
for sub_ind = 1:numel(sub_names)
    ...
    for con_ind = 1:length(con)
        ...
        V_con = sprintf('/media/tw260/X6/Effort/analysis/l1output-Effort-%s/%s/contrasts/_subject_id_%s/_fwhm_0/con_%04d.nii',analysis_name,sub_names{sub_ind},sub_names{sub_ind},con(con_ind)); % specific for subject
